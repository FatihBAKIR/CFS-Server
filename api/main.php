...
class quicksql
{
	...
	{
		$file = new file(
		$this->serversetting("script_adress")."/dosya/".@mysql_result($query, 0, "id")."/".@mysql_result($query, 0, "baslik"), 
	...
	public function InternalFile($id)
	{
		$query = mysql_query("select * from yuklemeler where id='".$id."'");
		return $this->serversetting("script_adress")."/".$this->serversetting("up_path")."/".@mysql_result($query, 0, "depolanandosya");
	}
